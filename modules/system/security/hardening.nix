...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    security = {
      ...
      # SECURITY: Enabled to prevent runtime kernel module loading after boot
      # This provides defense-in-depth against kernel rootkits
      # Note: Custom modules must be built into initrd or loaded during boot
